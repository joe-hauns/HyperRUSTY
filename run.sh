...
#=== fmcp ===#
# cargo run --release -- -v verilog_benchmarks/iodine-benchmarks/fpu/fcmp/verilog/build.ys verilog_benchmarks/iodine-benchmarks/fpu/fcmp/verilog/build.ys -t fcmptop -o fcmp.smt2 -f verilog_benchmarks/iodine-benchmarks/fpu/fcmp/verilog/formula.hq -k 1 -s pes
...
#small
#RUST_BACKTRACE=1 cargo run --release -- -v verilog_benchmarks/iodine-benchmarks/fpu/verilog/build_small.ys verilog_benchmarks/iodine-benchmarks/fpu/verilog/build_small.ys -t fdiv_harness -o fpu_small.smt2 -f verilog_benchmarks/iodine-benchmarks/fpu/verilog/formula.hq -k 2 -s pes -c
...
#=== ACDB original ===#
# time cargo run --release -- -n benchmarks/async/1_acdb/original/acdb_flattened.smv benchmarks/async/1_acdb/original/acdb_flattened.smv -f benchmarks/async/1_acdb/original/acdb.hq -k 6 -m 12 -s hpes -q
...
#=== Optimization - DBE ===#
# time cargo run --release -- -n benchmarks/async/4_optimization/original/dbe/DBE_source.smv benchmarks/async/4_optimization/original/dbe/DBE_target.smv -f benchmarks/async/4_optimization/original/dbe/DBE.hq -k 4 -m 8 -s hpes -q


#=== Optimization - DBE ndet ===#
# time cargo run --release -- -n benchmarks/async/4_optimization/with_ndet/dbe/DBE_source_ndet.smv benchmarks/async/4_optimization/with_ndet/dbe/DBE_target_ndet.smv -f benchmarks/async/4_optimization/with_ndet/dbe/DBE.hq -k 13 -m 26 -s hpes -q

#=== Optimization - DBE ndet w/bug ===#
# time cargo run --release -- -n benchmarks/async/4_optimization/with_ndet/dbe/DBE_source_ndet.smv benchmarks/async/4_optimization/with_ndet/dbe/DBE_target_wrong_ndet.smv -f benchmarks/async/4_optimization/with_ndet/dbe/DBE.hq -k 13 -m 26 -s hpes -q
